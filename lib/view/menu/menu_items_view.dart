...
class _MenuItemsViewState extends State<MenuItemsView> {
  ...
  List<Map<String, dynamic>> menuItemsArr = []; // Initialize empty list
  ...
  Future<void> _fetchMenuItems() async {
    ...
    List<Map<String, dynamic>> fetchedMenuItems = await FirebaseService().getRestaurants();
    setState(() {
      menuItemsArr = fetchedMenuItems;
    });
  }
